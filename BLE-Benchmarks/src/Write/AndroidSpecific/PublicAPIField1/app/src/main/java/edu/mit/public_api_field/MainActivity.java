...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String bytesString = bytesToWrite.toString(); //source
        float fx = Float.valueOf(bytesString.substring(0, 8));
        float fy = Float.valueOf(bytesString.substring(8));
        PointF point = new PointF(fx, fy);

        String newbytes = point.x + "" + point.y;
        mBluetoothGattCharacteristic.setValue(newbytes); //sink, leak
    }
